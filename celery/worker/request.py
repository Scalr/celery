...
class Request:
    ...
    def __init__(
        ...
        **opts
        ...
        # FAM-390: amqp_user_id is needed for Scalarizr tasks authorization.
        # Covered by medium test test_authorizing_task.
        if properties.get("user_id"):
            self._delivery_info["amqp_user_id"] = properties.get("user_id")
...
=======
            ...
            args=(self._type, task_id, self._request_dict, self._body,
                  self._content_type, self._content_encoding),
>>>>>>> 49cf9072f33681660e8aa75cc41520b81c5dbb97
    ...
    def execute(self, loglevel=None, logfile=None):
        ...
        request.update(
            {"loglevel": loglevel, "logfile": logfile, "is_eager": False, },
            **embed or {}
        )
